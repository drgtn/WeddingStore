...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="content">
                <div class="categoriesTitle">Cele mai recente anunturi</div>
                <%
                ...
                <div class="productDetails">
                    <div class="productPhoto">
                     ...
                     <%}else{%>
                       <a href="showproducts.htm?idProduct=<%=produs.getId()%>"><div class="productPhoto2"></div></a>
            ...
            <div class="pagination">   
                ...
                <c:if test="${currentPage != 1}">
                    <a href="main.htm?idCat=${categorie.id}&page=${currentPage - 1}">&nbsp;Previous</a>
                </c:if>
                ...
                <c:forEach begin="1" end="${noOfPages}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="main.htm?idCat=${categorie.id}&page=${i}">${i}&nbsp;</a>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <a href="main.htm?idCat=${categorie.id}&page=${currentPage + 1}">&nbsp;Next</a>
                </c:if>
            </div>   
