...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="content">
                <div class="categoriesTitle"> Adauga categorie</div>
                <div style="color:red; margin-bottom:10px; font-size:17px;">${categorieadaugata}</div>

                <form id="formID" action="<%=response.encodeURL(request.getContextPath()) + "/addcategoryadmin"%>" method="POST"  >
                        ...
                        <tr>
                            <td>
                                <div class="region">
                                    ...
                                    <input  maxlength="30" type="text" name="categorie" id="user" />
                                </div>
                            </td>
