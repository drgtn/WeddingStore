           ...
           <div class="content">
            ...
            <div class="pagination">   
                ...
                <c:if test="${currentPage != 1}">
                    <a href="home.htm?idCat=${categorie.id}&page=${currentPage - 1}">&nbsp;Previous</a>
                </c:if>
                ...
                <c:forEach begin="1" end="${noOfPages}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <a href="home.htm?idCat=${categorie.id}&page=${i}">${i}&nbsp;</a>
                        </c:otherwise>
                    </c:choose>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <a href="home.htm?idCat=${categorie.id}&page=${currentPage + 1}">&nbsp;Next</a>
                </c:if>
