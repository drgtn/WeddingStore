...
public class showcategoryproducts extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("listaProduse", listaProduse);
            request.setAttribute("noOfPages", noOfPages);
            request.setAttribute("currentPage", page);
           

            rd = request.getRequestDispatcher("/WEB-INF/pages/showcategoryproducts.jsp");
        } catch (Exception e) {
